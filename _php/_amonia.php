...
<html>
	...
	<body>
		...
		<main class="servicos container">
            <center>
				<h2>Histórico do ambiente (amônia)</h2>
				<table class="footable toggle-square-filled" data-page-size="20">
					<thead>
					...
					<?php
						...
						$consulta = mysql_query("select id_amonia, valor_amonia, data_hora from amonia");
						
						while($linha = mysql_fetch_array($consulta)){
							echo '<tbody>';
								echo '<tr>';
									echo '<td>'.$linha["id_amonia"].'</td>';
									echo '<td>'.$linha["valor_amonia"].'</td>';
