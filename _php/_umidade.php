            ...
            <center>
				...
				<table class="footable toggle-square-filled">
					...
					<?php
						...
						$consulta = mysql_query("select id_umidade, valor_umidade, data_hora from umidade");
						
						while($linha = mysql_fetch_array($consulta)){
							echo '<tr>';
								echo '<td>'.$linha["id_umidade"].'</td>';
								echo '<td>'.$linha["valor_umidade"].'</td>';
