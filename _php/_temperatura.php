...
<html>
	<head>
		...
		<script type="text/javascript" src="../_javascript/footable.filter.js"></script>
	</head>
	<body>
		<!-- CABEÇALHO --> 
		...
		<main class="servicos container">
            <center>
				...
				<br>
				<input class="bg-black radius" type="text" id="filtro" name="filtrar" placeholder="Filtrar">
				<br>
				<br>
				<table class="footable toggle-square-filled" data-filter="#filtro" data-filter-minimum="2">
					<thead>
					...
					<?php
						...
						$consulta = mysql_query("select id_temp, valor, data_hora from temperatura");
						
						while($linha = mysql_fetch_array($consulta)){
							echo '<tbody>';
								echo '<tr>';
									echo '<td>'.$linha["id_temp"].'</td>';
